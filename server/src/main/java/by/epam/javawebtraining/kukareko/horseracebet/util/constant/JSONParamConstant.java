...
public class JSONParamConstant {
    ...
    public static final String REQUEST_PARAM_LOGIN = "requestParam.login";
    ...
    public static final String RESPONSE_PARAM_STATUS_SUCCESS = "responseParam.status.success";
    public static final String RESPONSE_PARAM_ROLE = "responseParam.role";
    public static final String RESPONSE_PARAM_STATUS_FAILED = "responseParam.status.failed";
    public static final String RESPONSE_PARAM_STATUS = "responseParam.status";
    public static final String RESPONSE_PARAM_ERROR_MES = "responseParam.errorMes";
